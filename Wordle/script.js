...
clueButton.addEventListener("click", revealWord);

function revealWord() {

  if (count < 5) {

    wordDisplay.textContent += targetWord[count];
    count++;
    if (count < 5) {
  ...
  if (count === 5) {
    stopInteraction();
    showAlert("All Letters revealed!! You Lost😭 The word is".concat(" ", targetWord));
    clearInterval(intervalRef);
}
}
